...
class CitationManager:
    ...
    def __init__(self, model_provider="groq"):
        try:
            ...
            error_msg = f"Error in CitationManager.__init__: {str(e)}"
    ...
    def format_citation(self, source, style="APA"):
        ...
        try:
            ...
            error_msg = f"Error in format_citation: {str(e)}"
            logger.error(error_msg)
            return self._format_basic_citation(source)
    ...
    def _format_apa_citation(self, source):
        ...
        try:
            ...
            error_msg = f"Error in _format_apa_citation: {str(e)}"
            logger.error(error_msg)
            return source.get("title", "Unknown Title")
    ...
    def _format_mla_citation(self, source):
        ...
        try:
            ...
            error_msg = f"Error in _format_mla_citation: {str(e)}"
            logger.error(error_msg)
            return source.get("title", "Unknown Title")
    ...
    def _format_chicago_citation(self, source):
        ...
        try:
            ...
            error_msg = f"Error in _format_chicago_citation: {str(e)}"
            logger.error(error_msg)
            return source.get("title", "Unknown Title")
    ...
    def _format_basic_citation(self, source):
        ...
        try:
            ...
            error_msg = f"Error in _format_basic_citation: {str(e)}"
            logger.error(error_msg)
